...
study of microchannel plate photomultipliers (MCPs) as the active element of a
...
experiment~\cite{CMSHGCal}, indicating that such calorimeters have promising 
...
about $3$ or $4$ pixels, and then becomes flat as we include more pixels. 
The initial $1/\sqrt{N}$ scaling is encouraging as it indicates that further 
granularity may improve the time resolution. As the 
majority of the shower is covered by the pixels closest to the center of the 
shower, it is not surprising that beyond about $4$ pixels, we do not observe any 
improvement from the inclusion of additional pixels.
